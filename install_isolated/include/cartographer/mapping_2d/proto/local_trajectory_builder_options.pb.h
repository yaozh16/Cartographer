...
class LocalTrajectoryBuilderOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_loop_closure_adaptive_voxel_filter_options() const;
  inline void clear_loop_closure_adaptive_voxel_filter_options();
  static const int kLoopClosureAdaptiveVoxelFilterOptionsFieldNumber = 20;
  inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& loop_closure_adaptive_voxel_filter_options() const;
  inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* mutable_loop_closure_adaptive_voxel_filter_options();
  inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_loop_closure_adaptive_voxel_filter_options();
  inline void set_allocated_loop_closure_adaptive_voxel_filter_options(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* loop_closure_adaptive_voxel_filter_options);
 ...
 private:
  ...
  inline void set_has_loop_closure_adaptive_voxel_filter_options();
  inline void clear_has_loop_closure_adaptive_voxel_filter_options();
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions::mutable_loop_closure_adaptive_voxel_filter_options() {
  ...
  if (loop_closure_adaptive_voxel_filter_options_ == NULL) loop_closure_adaptive_voxel_filter_options_ = new ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions;
