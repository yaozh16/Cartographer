...
class FastCorrelativeScanMatcherOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_min_low_resolution_score() const;
  inline void clear_min_low_resolution_score();
  static const int kMinLowResolutionScoreFieldNumber = 9;
  inline double min_low_resolution_score() const;
  inline void set_min_low_resolution_score(double value);
 ...
 private:
  ...
  inline void set_has_min_low_resolution_score();
  inline void clear_has_min_low_resolution_score();
