...
class SubmapQuery_Response_SubmapTexture : public ::google::protobuf::Message {
 public:
  ...
  SubmapQuery_Response_SubmapTexture* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class SubmapQuery_Response : public ::google::protobuf::Message {
 public:
  ...
  inline const ::cartographer::mapping::proto::SubmapQuery_Response_SubmapTexture& textures(int index) const;
  inline ::cartographer::mapping::proto::SubmapQuery_Response_SubmapTexture* mutable_textures(int index);
  inline ::cartographer::mapping::proto::SubmapQuery_Response_SubmapTexture* add_textures();
