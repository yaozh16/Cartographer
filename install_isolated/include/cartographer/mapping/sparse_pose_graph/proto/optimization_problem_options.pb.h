...
class OptimizationProblemOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_fixed_frame_pose_translation_weight() const;
  inline void clear_fixed_frame_pose_translation_weight();
  static const int kFixedFramePoseTranslationWeightFieldNumber = 11;
  inline double fixed_frame_pose_translation_weight() const;
  inline void set_fixed_frame_pose_translation_weight(double value);

  // optional double fixed_frame_pose_rotation_weight = 12;
  inline bool has_fixed_frame_pose_rotation_weight() const;
  inline void clear_fixed_frame_pose_rotation_weight();
  static const int kFixedFramePoseRotationWeightFieldNumber = 12;
  inline double fixed_frame_pose_rotation_weight() const;
  inline void set_fixed_frame_pose_rotation_weight(double value);
 ...
 private:
  ...
  inline void set_has_fixed_frame_pose_translation_weight();
  inline void clear_has_fixed_frame_pose_translation_weight();
  inline void set_has_fixed_frame_pose_rotation_weight();
  inline void clear_has_fixed_frame_pose_rotation_weight();
