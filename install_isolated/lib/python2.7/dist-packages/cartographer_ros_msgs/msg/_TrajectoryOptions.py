...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B4i3d().pack(_x.provide_odom_frame, _x.use_odometry, _x.num_laser_scans, _x.num_multi_echo_laser_scans, _x.num_subdivisions_per_laser_scan, _x.num_point_clouds, _x.rangefinder_sampling_ratio, _x.odometry_sampling_ratio, _x.imu_sampling_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.provide_odom_frame, _x.use_odometry, _x.num_laser_scans, _x.num_multi_echo_laser_scans, _x.num_subdivisions_per_laser_scan, _x.num_point_clouds, _x.rangefinder_sampling_ratio, _x.odometry_sampling_ratio, _x.imu_sampling_ratio,) = _get_struct_2B4i3d().unpack(str[start:end])
