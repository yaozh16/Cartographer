...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B4i3d().pack(_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.imu_sampling_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.imu_sampling_ratio,) = _get_struct_2B4i3d().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2B4i3d = None
def _get_struct_2B4i3d():
    global _struct_2B4i3d
    if _struct_2B4i3d is None:
        _struct_2B4i3d = struct.Struct("<2B4i3d")
    return _struct_2B4i3d
# This Python file uses the following encoding: utf-8
